...
Indexical requires a current version of Node/NPM. To create a Node

To create a new project, run the following command, which will install the project generator (if needed) and create a project with the provided name in the current directory:
